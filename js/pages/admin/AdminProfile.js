            ...
            <div class="fade-in" style="max-width: 960px; margin: 0 auto;">
                ...
                <div class="profile-grid">
                    <div class="profile-card card" style="padding: 28px;">
                        <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 24px;">
                            ...
                            <div>
                                ...
                                <p style="margin: 6px 0 0 0; color: var(--text-muted); font-size: 13px;">Your admin profile details are stored locally in the browser.</p>
                            </div>
                        </div>
                    ...
                    <div style="display: grid; gap: 20px;">
                        <div class="profile-card card" style="padding: 28px;">
                            <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 24px;">
                                <div style="width: 40px; height: 40px; border-radius: 14px; background: var(--accent-glow); color: var(--accent-hover); display: flex; align-items: center; justify-content: center; border: 1px solid rgba(99, 102, 241, 0.2);"><i data-lucide="lock" style="width: 20px;"></i></div>
                                <div>
                                    <h3 style="margin: 0; font-size: 18px;">Security</h3>
                                    <p style="margin: 6px 0 0 0; color: var(--text-muted); font-size: 13px;">Change your password and keep your access secured.</p>
                                </div>
                            </div>
                            <form id="admin-password-form" style="display: grid; gap: 18px;">
                                ...
                                <button type="submit" class="btn btn-outline btn-pill" style="width: 180px; color: var(--accent-hover); border-color: var(--accent);">Change Password</button>
                            </form>
                        </div>

                        <div class="card" style="padding: 24px; background: var(--danger-bg); border: 1px solid var(--danger-border);">
                            <h3 style="margin-top: 0; font-size: 18px; color: var(--danger);">Session Control</h3>
                            <p style="margin: 10px 0 18px 0; color: var(--text-muted); font-size: 13.5px; line-height: 1.5;">Use the button below to safely end your current admin session.</p>
                            <button id="btn-logout" class="btn btn-ghost btn-pill" style="width: 100%; background: rgba(239, 68, 68, 0.15); color: var(--danger); border: 1px solid var(--danger-border);">Logout from System</button>
                        </div>
                    </div>
                </div>
            </div>
